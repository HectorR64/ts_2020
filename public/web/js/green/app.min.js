...
function(c, p) {
	...
	c.fn.dropdownHover = function(l) {
		return "ontouchstart" in document ? this : (u = u.add(this.parent()), this.each(function() {
			...
			function r() {
				p.clearTimeout(t), p.clearTimeout(o), o = p.setTimeout(function() {
					u.find(":focus").blur(), !0 === s.instantlyCloseOthers && u.removeClass("show"), p.clearTimeout(o), n.attr("aria-expanded", "true"), e.addClass("show"), n.trigger(a)
				}, s.hoverDelay)
			}
			e.hover(function(t) {
				if (!e.hasClass("show") && !n.is(t.target)) return !0;
				767 < c(p).width() && r()
			}, function() {
				767 < c(p).width() && (p.clearTimeout(o), t = p.setTimeout(function() {
					n.attr("aria-expanded", "false"), e.removeClass("show"), n.trigger("hide.bs.dropdown")
				}, s.delay))
			}), n.hover(function(t) {
				if (!e.hasClass("show") && !e.is(t.target) && 767 < c(p).width()) return !0;
				767 < c(p).width() && r()
	...
	a.prototype.init = function() {
		...
		c.hasTransitionSupport() ? o.css({
			"-ms-transform" : "scale(" + n + ")", "-moz-transform": "scale(" + n + ")",
