     ...
     height:1000px;">
                ...
                <div class="col-sm-6 col-lg-3" id="singleItem">
                  ...
                  <div class="card card-pricing ">
                    ...
                    <input type="hidden" id="itemimg" value="{{ $product -> image_path }}">
                    <input type="hidden" id="itemName" value="{{$product->product_name}}">
                    <h6 style="font-weight:bold;" class="card-category">{{$product->product_name}}</h6>
                    <div class="card-body">
     ...
     <div class="col-md-4">
        ...
        height:100px;">
            <div class="card-header card-header-info card-header-icon">
                  ...
                  <div class="card-title">
                   ...
                   <div class="col-md-6 ml-auto" >
                      ...
                      <option value="{{$client->id}}">{{__($client->name)}}</option>
                    @endforeach
            ...
            <div class="card">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <button  type="button" class="btn btn-danger btn-round"><i class="material-icons">delete</i>Cancelar</button>
                    </div>
...
$.ajax({
                    ...
                    success: function (data) {
                        ...
                        var sale_price = data.product[0].sale_price;
                        ...
                        var html =
                            ...
                            <td style="display: flex;">
                                <input id="qty" style="width: 60% !important;" type="number" name="quantity[]"
                                    data-sale_price="${sale_price}" data-stock="${stock}"
